...
public class FoodItemResponseDTO {
	...
	public FoodItemResponseDTO(int foodId, String foodName, double price, double offer, String foodCategory,
			String foodDescription, String thumbnail, int restaurantId, String restaurantName,
	...
	public String toString() {
		return "FoodItemResponseDTO [foodId=" + foodId + ", foodName=" + foodName + ", price=" + price + ", offer="
